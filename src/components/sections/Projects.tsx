...
const Portfolio = ({
    ...
    // We only need the setter for local fallback if no external setter is provided
    // but without the value being used, it's effectively a no-op state, which is fine for fallback.
    const [, localSetHovered] = useState<PortfolioItem | null>(null);
            ...
            >
                <div className="max-w-[1800px] w-full h-full mx-auto px-8 flex flex-row gap-12 items-center justify-center">
                    ...
                    <div className="w-full h-full flex flex-col justify-center pt-8 font-sans overflow-visible items-center">
                        ...
                        >
                            <h2 className="text-3xl sm:text-4xl lg:text-6xl font-black text-text uppercase tracking-[0.2em] text-center mb-2">
                                OUR PORTFOLIO
                            </h2>
                            <div className="w-16 h-1 sm:w-20 lg:w-24 bg-accent/40 rounded-full" />
                        </motion.div>
