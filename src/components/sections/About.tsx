            ...
            <div className="w-full max-w-[1240px] mx-auto relative z-10 flex justify-center items-center">
                ...
                >
                    ...
                    <motion.div
                        ...
                        className="w-full glass-card running-border rounded-[4rem] md:rounded-[6rem] relative pt-16 pb-24 md:pt-20 md:pb-32"
                        style={{ maxWidth: isDesktop ? '850px' : 'calc(100% - 2rem)' }}
                    >
